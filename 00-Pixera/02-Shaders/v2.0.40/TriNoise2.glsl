...
struct TriNoise2 {
	sampler2D sampler;
  //@ label: "Mix[%]", editor: range, min: 0, max: 1, range_min: 1, range_max: 100, range_default: 0
	float noiseScale;
	//@ label: "time", editor: range, min: 0, max: 100, range_min: 0, range_max: 100, range_default: 1
	float time;
