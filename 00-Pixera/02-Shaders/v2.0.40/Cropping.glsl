...
struct Cropping {
  ...
  float left;
  //@ label: "Left Softness[%]", editor: range, min: 0, max: 1, range_min: 0, range_max: 100, range_default: 0
  float left_softness;
  //@ label: "Top", editor: range, min: 0, max: 1, range_min: 0, range_max: 100, range_default: 0
  float top;
  //@ label: "Top Softness[%]", editor: range, min: 0, max: 1, range_min: 0, range_max: 100, range_default: 0
  float top_softness;
  //@ label: "Right", editor: range, min: 0, max: 1, range_min: 0, range_max: 100, range_default: 0
  float right;
  //@ label: "Right Softness[%]", editor: range, min: 0, max: 1, range_min: 0, range_max: 100, range_default: 0
  float right_softness;
  //@ label: "Bottom", editor: range, min: 0, max: 1, range_min: 0, range_max: 100, range_default: 0
  float bottom;
  //@ label: "Bottom Softness[%]", editor: range, min: 0, max: 1, range_min: 0, range_max: 100, range_default: 0
