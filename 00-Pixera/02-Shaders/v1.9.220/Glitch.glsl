...
struct Glitch{
	sampler2D sampler;
	//@ label: "Mix[%]", editor: range, min: 0.0, max: 1.0, range_min: 0, range_max: 100, range_default: 0.0
	float mix;
	//@ label: "time", editor: range, min: 0, max: 50, range_min: 0, range_max:50, range_default: 0
	float time;
