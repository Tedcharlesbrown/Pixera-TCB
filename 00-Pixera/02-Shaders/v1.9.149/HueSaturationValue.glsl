...
struct HueSaturationValue {
  ...
  float mix;
  //@ label: "Hue[deg]", editor: range, min: 0, max: 1, range_min: 0, range_max: 360, range_default: 0
  float hue;
  //@ label: "Saturation[%]", editor: range, min: -1, max: 1, range_min: -100, range_max: 100, range_default: 0
  float saturation;
  //@ label: "Value[%]", editor: range, min: -1, max: 1, range_min: -100, range_max: 100, range_default: 0
  float value;
};
