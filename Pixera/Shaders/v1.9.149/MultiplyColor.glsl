...
struct MultiplyColor {
  ...
  float mix;
  //@ label: "Red", editor: range, min: 0, max: 2, range_min: 0, range_max: 255, range_default: 127
  float red;
  //@ label: "Green", editor: range, min: 0, max: 2, range_min: 0, range_max: 255, range_default: 127
  float green;
  //@ label: "Blue", editor: range, min: 0, max: 2, range_min: 0, range_max: 255, range_default: 127
  float blue;
